  ...
  return (
    <section className="relative h-full w-full bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-24">
        ...
        >
          <h2 className="text-5xl md:text-8xl font-sans font-black tracking-tight text-white uppercase">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <motion.div 
            ...
            transition={{ duration: 1, ease: "easeOut" }}
            className="relative bg-brand-gold/10 backdrop-blur-md p-8 md:p-14 border border-white/10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
              ...
              <div className="space-y-6">
                ...
                <p className="text-white/80 text-[11px] md:text-xs leading-relaxed font-light">
              ...
              <div className="space-y-6 flex flex-col justify-between">
                ...
                <p className="text-brand-gold text-sm md:text-base leading-relaxed font-bold italic pt-8 border-t border-white/10">
      ...
      <div className="absolute bottom-6 left-6 z-30 flex items-center space-x-6 text-white/40">
        ...
        <div className="flex items-center space-x-4">
          <a href="#" className="hover:text-brand-gold transition-colors"><Facebook className="w-4 h-4 fill-current" /></a>
          <a href="#" className="hover:text-brand-gold transition-colors"><Youtube className="w-4 h-4" /></a>
          <a href="#" className="hover:text-brand-gold transition-colors text-[10px] font-bold">Zalo</a>
        </div>
      </div>

      <div className="absolute bottom-6 right-6 z-30 flex items-center space-x-8 text-white/60">
