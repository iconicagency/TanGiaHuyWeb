    ...
    <section className="relative h-full w-full bg-black overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        <div className="mr-6 md:mr-16">
          <h2 className="text-white text-3xl md:text-5xl lg:text-6xl font-sans font-bold tracking-tight uppercase [writing-mode:vertical-rl] rotate-180 transform select-none opacity-80 mix-blend-difference">
            TIN MỚI
          </h2>
        </div>
