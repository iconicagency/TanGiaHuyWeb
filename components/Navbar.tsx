  ...
  return (
    <>
      <div className={cn(
        ...
        <nav className="pointer-events-auto w-full mx-auto max-w-[1920px] bg-white/50 backdrop-blur-md rounded-lg flex items-center justify-between px-6 py-2 md:py-3 shadow-[0_4px_20px_rgba(0,0,0,0.05)] text-black transition-all duration-500 border border-[#D5D3CE]/50 overflow-hidden">
